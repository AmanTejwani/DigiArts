            ...
            <div className="flex justify-between items-center mt-3 text-white ">
              <div className="flex justify-start items-center ">
                <Identicon
                  string={nft?.owner}
                  size={50}
                  className="h-10 w-10 object-contain rounded-full mr-3 bg-[#00cc66]"
                />
                <div className="flex flex-col justify-center items-start">
                  <small className="text-white font-bold">@owner</small>
                  <small className="text-gree-800 font-semibold">
          ...
          <div className="flex justify-between items-center space-x-2">
            {connectedAccount == nft?.owner ? (
              <button
                ...
                w-full text-black text-md border-black
                py-2 px-5 rounded-full 
                drop-shadow-xl border hover:bg-[#00cc66]
                hover:text-black bg-[#66ff33]
